 ...
 #include <LiquidCrystal.h>
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=4SHYJLK0BWQ7O9MQ";     
  const char* url2 = "/apps/thinghttp/send_request?api_key=P13YBNR40WI0LDTU";   
  const char* url3 = "/apps/thinghttp/send_request?api_key=EOEI1HVPDOAG4RNL";   
  int To_remove;      //
  ...
  void setup() {
    lcd.begin(16, 2);
    lcd.setCursor(1, 0);
    lcd.print("Available Beds"); 
    lcd.setCursor(1, 1);
    lcd.print("LifeSavers");  
